...
async def stats(_, message):
    ...
    stats = (
        ...
        f"<b>⬆️Upload:</b> {get_readable_file_size(net_io_counters().bytes_sent)}\n"
        f"<b>⬇️Download:</b> {get_readable_file_size(net_io_counters().bytes_recv)}\n\n"
        ...
        f"<b>🔰Powerd By🔰:</b><a href="https://t.me/scroobots"><b>ScrooBots</b></a>\n"
    )
...
async def start(client, message):
    buttons = ButtonMaker()
    buttons.ubutton("Private Repo", "scrooge010")
    buttons.ubutton("Owner", "https://t.me/scrooge010")
