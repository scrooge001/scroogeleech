...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/scroobots"><i class="fab fa-github"></i></a>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-leech-telegram-bot <a href='https://www.github.com/scroobots'>@GitHub</a> By <a href='https://github.com/scrooge010'>Anas</a></h1>"
